...
export default function Search() {
  ...
  return (
    <Layout>
      <div className="p-4 sm:p-6 lg:p-8 max-w-[1200px] mx-auto" data-testid="search-page">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900">{t.nav.search}</h1>
